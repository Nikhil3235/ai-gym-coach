...
LANGUAGE_OPTIONS = {
    ...
    "Hindi": {
        ...
        "prompt_suffix": (
            ...
            "You MUST reply ONLY in Hindi (Devanagari script). "
            "Do NOT use English at all. Use natural Hindi phrases a gym trainer would say. "
            "Example: 'शाबाश! पीठ सीधी रखो और गहरे जाओ!'\n"
        ),
    },
    "Marathi": {
        "tts_code": "mr",
        "prompt_suffix": (
            "\n\n### IMPORTANT LANGUAGE RULE\n"
            "You MUST reply ONLY in Marathi (Devanagari script). "
            "Do NOT use English or Hindi. Use natural Marathi phrases a gym trainer would say. "
            "Example: 'छान! पाठ सरळ ठेवा आणि अजून खाली जा!'\n"
        ),
    },
}
